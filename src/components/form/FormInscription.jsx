...
const FormInscription = () => {
    <style jsx global>{`
        ...
        input:-moz-autofill {
          box-shadow: 0 0 0px 1000px #f3f4f6 inset;
...
Telefono: ${telefono}`;
    ...
    return (
        <form className="border bg-white bg-opacity-20 backdrop-blur-sm rounded-lg" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="text-white md:w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ">Submit</button>
            </div>
        </form>
    );
};
